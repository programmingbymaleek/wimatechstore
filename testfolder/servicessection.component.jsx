	...
	return (
		<div className="px-12 flex flex-col py-8" id="services">
			<div className="mx-auto max-w-2xl lg:mx-0">
				<p className="head-medium tracking-tight font-semibold text-gray-900">Services</p>
				<p className="mt-4 text-normal leading-6 text-gray-900">
					At Certified Global Enterprise, we provide a comprehensive suite of services designed to meet the diverse
					needs of our clients. From advanced IT solutions and precise engineering services to expert consultancy
					and a robust eCommerce platform, we are committed to delivering excellence and driving success for your
					business.
				</p>
			</div>
			<div className="md:mt-12 mt-8 flex flex-col gap-8">
				<div className="flex flex-col gap-4 w-full">
					...
					<div className="md:gap-8 gap-6 grid grid-cols-3 w-full">
						<Card service={services[0]} openModal={openModal} customLinks={"ecommerce"} />
						<Card service={services[5]} openModal={openModal} customLinks={"softwaredevelopment"} />
			...
			{modal && <ServiceModal service={services[selectedService - 1]} closeModal={closeModal} />}
		</div>
	);
};
