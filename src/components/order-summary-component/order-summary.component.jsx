...
const OrderSummary = () => {
  return (
    <div class="mt-6 w-full space-y-6 sm:mt-8 large:mt-0 large:max-w-sm xl:max-w-md border shadow-sm h-[60vh]">
      <div class="flow-root border-b p-5">
        <div class="-my-3">
          <dl class="flex items-center justify-between gap-4 py-3 pb-5">
            <Text
          ...
          <div class="flex items-center justify-between gap-4 py-0.5 pb-4">
            <Text
              texttype="text-normal"
              textstyles=" font-normal text-gray-500 dark:text-gray-400"
            >
