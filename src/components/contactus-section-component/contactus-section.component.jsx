      ...
      <div className="flex flex-col gap-3 list-style-none m-0 p-0">
        ...
        <div className="flex tablet:flex-row flex-col gap-3 h-12 mt-4 list-style-none m-0 p-0">
          <InputBox
            ...
            name="email"
            inputstyles="medium:w-8/12 tablet:w-9/12 w-full tablet:h-full h-12 px-4 tablet:py-auto py-2.5 border border-[#3a3a3a]/20 shadow-sm focus:outline-none focus:border-blue-400 focus:ring-blue-700 focus:ring-1 "
          />
          <Button
