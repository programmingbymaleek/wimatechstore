...
const Filter = () => {
  ...
  const filterData = () => {
    ...
    const selectedCategories = Object.keys(checkedItems).filter((category) => checkedItems[category]);
  ...
  const buttonData = [
    '100-199.99', '200-299.99', '300-399.99', '400-499.99', '500-599.99',
    '600-699.99', '700-799.99', '800-899.99', '900-999.99', '1000-1099.99',
    '1100-1199.99', '1200-1299.99', '1300-1399.99', '1400-1499.99', '1500-1599.99',
    '1600-1699.99', '1700-1799.99', '1800-1899.99', '1900-1999.99'
  ];
  ...
  return (
    <div className="house" style={{ display: "flex" }}>
        ...
        <div className="w-full">
          ...
          <div className="flex flex-col gap-3 pt-6">
            {buttonData.map((range) => (
              <Button
                key={range}
                buttonstyles={`text-gray-600 px-2 py-1.5 rounded-md ${selectedPriceRange === range ? 'bg-gray-600 text-white' : ''}`}
