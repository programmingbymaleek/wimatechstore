...
export const ContactUsSection = () => {
	...
	const handleSubmit = async (e) => {
		...
		try {
			const res = await fetch("https://us-central1-certifiedglobalenterprise.cloudfunctions.net/sendContactEmail", {
				method: "POST",
				headers: {
			...
			setResponse(data); // Handle response from the server
		} catch (error) {
	...
	return (
		...
		>
			<div className=" col-span-6">
				<p className="head-medium tracking-tight font-semibold text-gray-900 capitalize">Contact Us</p>
				<p className="md:mt-1 mt-0 text-normal leading-6 text-gray-900 text-left max-w-xl">
					Have questions or need more information? Our team is ready to assist you. Reach out to us via phone,
			...
			<form className="col-span-6 mt-6" onSubmit={handleSubmit}>
						...
						<div>
							<div className="md:mt-2.5">
								<input
									...
									pattern="[A-Za-z\s]{1,200}" // Limits input to letters and spaces, up to 200 characters
						...
						<div className=" sm:col-span-2">
							<div className="mt:2.5">
								<textarea
									...
									rows="10"
									pattern="[\s\S]{1,500}" // Limits message to 500 characters
