...
export const FooterSection = () => {
  return (
    <footer className=" bg-[#F9F9F9]  w-full py-4">
      <div className="mx-auto max-w-7xl w-full md:px-12 px-8">
        <div className="flex md:justify-between pt-8 md:flex-row flex-col-reverse">
          <div className="grid xs:grid-cols-2 grid-cols-1 lmd:flex lmd:flex-row lmd:flex-wrap lmd:justify-between gap-x-32 lmd:gap-y-2 gap-y-20 mlg:gap-20 xlg:gap-8 flex-1">
            ...
            <div className="Xlg:pr-32 pr-0 box-content">
        ...
        <div className="sm:flex sm:items-center sm:justify-between pt-16 pb-3">
          <span className="text-small text-gray-500 sm:text-center ">
            © 2024{" "}
            <a href="#" className="hover:underline">
